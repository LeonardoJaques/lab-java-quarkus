...
public class ResultResources {
    ...
    public Multi<List<Election>> getElections() {
        return Multi.createFrom().ticks().every(Duration.of(5, ChronoUnit.SECONDS)).onItem().transformToMultiAndMerge(n -> electionManagement.getElections().toMulti());
    }
