...
public class SQLElectionRepository implements ElectionRepository {
    ...
    public List<Election> findAll() {
        ...
        return map.entrySet()
                .stream()
                .map(entry -> {
                    Map.Entry[] candidates = entry.getValue()
                            .stream()
